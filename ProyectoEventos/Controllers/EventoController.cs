...
namespace ProyectoEventos.Controllers
{
    public class EventoController : Controller
    {
        ...
        public EventoController(EventosDbContext context)
        {
            _context = context;
        }
        ...
        {
            var eventosDbContext = _context.Eventos.Include(e => e.Usuario);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descripcion,FechaHora,Ubicacion,LinkCompra,Estado,UsuarioId")] Evento evento)
        {
            if (id != evento.Id)
            {
                return NotFound();
